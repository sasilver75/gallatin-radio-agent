...
Do not add Symphony/Codex orchestration harness code here. If a ticket mentions Symphony, treat it as an external executor that may work on this repository, not as part of the app architecture.
